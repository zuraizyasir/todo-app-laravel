  ...
  <div class="custom-background flex items-center justify-center p-4">
    <div class="custom-background-login p-8">
      ...
      <form @submit.prevent="register" class="space-y-6">
        <div>
          <label for="name" class="email-text">Full Name</label>
        ...
        <div>
          <label for="password" class="email-text">Password</label>
          <div class="mt-1 relative">
            <input
        ...
        <div>
          <label for="password_confirmation" class="email-text">Confirm Password</label>
          <div class="mt-1 relative">
            <input
            ...
            <button
              ...
              :disabled="isLoading"
            >
              <img v-if="showConfirmPassword" src="../../../public/images/view.png" />
              <img v-else src="../../../public/images/hide.png" />
            </button>
          </div>
        </div>
